                  ...
                  return (
                    <tr
                      className={cn(
                        ...
                        cost >= 162 && cost <= 180 && "bg-[#1ac000]",
                        cost >= 180 && cost <= 199 && "bg-[#33b300]",
                        cost >= 199 && cost <= 218 && "bg-[#4d9900]",
                        cost >= 218 && cost <= 237 && "bg-[#669900]",
                        cost >= 237 && cost <= 256 && "bg-[#808000]",
                        cost >= 256 && cost <= 275 && "bg-[#996600]",
                        cost >= 275 && cost <= 294 && "bg-[#b24c00]",
                        cost >= 294 && cost <= 313 && "bg-[#cc3200]",
                        cost >= 313 && cost <= 332 && "bg-[#e51900]",
                        cost >= 332 && cost <= 354 && "bg-[#ff0000]",
                        cost >= 354 && cost <= 400 && "bg-[#441111]"
                      )}
                      key={day}
                    >
